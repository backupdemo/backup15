        ...
        p = {
            ...
            geographyConfig: {
                ...
                popupTemplate: function (a, b) {
                    ...
                    return ['<div class="hoverinfo"> <strong style="color:white;font-size:15px;">' + a.properties.name+"<br>"+ "</strong>" +'<span style="color:white;text-decoration:underline;">'+window.str +"</span>"+"</div>"].join('');
                },
                popupOnHover: !0,
                highlightOnHover: !0,
